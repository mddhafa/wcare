...
<head>
    ...
    <title>Profil Psikolog - Sistem Curhat</title>
...
<body class="bg-gray-50 font-sans text-gray-800 min-h-screen flex flex-col">
    ...
    <main class="flex-grow py-10 px-4 sm:px-6">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-6">
                <a href="{{ route('psikolog.dashboard-psikolog') }}" class="inline-flex items-center text-gray-500 hover:text-primary transition font-medium">
            ...
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 relative">
                ...
                <div class="h-48 bg-gradient-to-r from-emerald-600 to-teal-500 relative">
                    ...
                    <div class="absolute top-0 right-0 p-4 opacity-20 text-white"><i class="fas fa-user-md text-8xl"></i></div>
                </div>
                ...
                <div class="px-8 pb-10">
                    ...
                    <div class="mb-8">
                        ...
                        <p class="text-gray-500 flex items-center gap-2 mt-1">
                            ...
                            <span class="px-2 py-0.5 rounded text-xs font-semibold bg-emerald-100 text-emerald-700 uppercase ml-2">
                                Psikolog Klinis
                            </span>
                        </p>
                    </div>
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-6 flex items-center gap-2">
                        <i class="fas fa-briefcase-medical text-primary"></i> Informasi Praktik
                    </h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-gray-50 p-4 rounded-xl border border-gray-100 flex items-start gap-4">
                            ...
                            <div>
                                <p class="text-sm text-gray-500 font-medium">Jam Mulai Praktik</p>
                                <p class="text-lg font-semibold text-gray-800">
                                    {{ $profile->jam_mulai ? \Carbon\Carbon::parse($profile->jam_mulai)->format('H:i') . ' WIB' : '-' }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-xl border border-gray-100 flex items-start gap-4">
                            ...
                            <div>
                                <p class="text-sm text-gray-500 font-medium">Jam Selesai Praktik</p>
                                <p class="text-lg font-semibold text-gray-800">
                                    {{ $profile->jam_selesai ? \Carbon\Carbon::parse($profile->jam_selesai)->format('H:i') . ' WIB' : '-' }}
                                </p>
                            </div>
                        </div>

                        <div class="bg-gray-50 p-4 rounded-xl border border-gray-100 flex items-start gap-4 md:col-span-2">
